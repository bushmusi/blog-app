...
RSpec.describe 'Posts show page', type: :feature do
  before(:each) do
    User.destroy_all
    @user = User.create(name: 'bisrat', photo: 'profile.png', bio: 'Developer',
                        email: 'bisrat@email.com', password: 'password',
    ...
    fill_in 'Email', with: 'bisrat@email.com'
  ...
  describe 'Specs for view posts#show' do
    ...
    it 'Can see who wrote the post' do
      expect(page).to have_content 'bisrat'
    end
